...
**Acceptance checklist (SC-002 focus)**:

- In the default web preview, the player can visually count **6 pockets** (4 corners + 2 side middles).
- Pockets are **not covered** by HUD or common overlays.
- After resizing the browser window (narrower + wider), pockets remain visible and countable.
...
**Independent Test**: Run `npm run dev:web` and visually confirm wood rails + 6 pockets are clearly visible and countable (SC-002).
...
**Independent Test**: Resize the browser window; verify 6 pockets remain visible/countable and not covered by HUD (SC-002).
