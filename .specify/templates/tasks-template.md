...
**Tests**: Follow the constitution's test-first rule. Add regression or failing-test tasks before implementation whenever the feature changes behavior.
...
- [ ] T012 [P] [US1] UI layout/non-overlap regression for [screen or overlay] in tests/[path]/test_[name].py
...
- Behavior-changing tests MUST be written and FAIL before implementation
